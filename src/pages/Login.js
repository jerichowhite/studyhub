...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const user = await loginUser(formData.email.trim(), formData.password, rememberMe);

      if (!user.emailVerified) {
        // Signed in but email not yet verified — send to verify page
        navigate('/verify-email', { replace: true });
        return;
      }

      // Fully authenticated — ProtectedRoute will handle further redirects
    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
        ...
        <div className="bg-blue-700 px-8 py-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-white">Welcome to StudyHub</h1>
        ...
        <div className="px-8 py-8 bg-white dark:bg-gray-800">
          ...
          <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link to="/register" className="font-medium text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 transition">
              Create one here
            </Link>
          </p>
        </div>
